'''
A heap is a tree where every parent is greater than its children (max-heaps ) or they are smaller than their children (min-heaps)
A Max heap & a Min heap are typically represented as an array. 
- The root element will be at Arr[0]. 
- Arr[(i-1)/2] Returns the parent node.
- Arr[(2*i)+1] Returns the left child node. 
- Arr[(2*i)+2] Returns the right child node. Operations on Max Heap (and min heap) include:
